...
class YOLOv8Detector(Node):  # 继承自 Node 类
    def __init__(self):
        ...
        self.image_sub = self.create_subscription(
            ArmDataCollect, "/right_arm_data_cmd", self.image_callback, 10
        )
    ...
    def get_detect(self, cv_image):
        ...
        results = self.model(source=cv_image, conf=0.3, imgsz=640, verbose=False)
        ...
        cv2.imwrite("./img/test" + str(self.img_count) + ".jpg", cv_image)
        self.img_count += 1
